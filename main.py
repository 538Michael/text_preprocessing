...
from libs.limpeza import limpa_caracteres_especiais, limpa_palavras_pequenas
from libs.limpeza import limpa_sem_acentos, limpa_stopwords2, save_file
from libs.limpeza import limpa_substantivos, limpa_texto_verbo, pega_nomes_proprios
from libs.limpeza import limpa_texto_arcaismo, limpa_texto_final
from util import *
...
with open('./files.txt', 'r', encoding='utf-8') as fs:
    ...
    for file in files:
        ...
        texto_limpo_p2, texto_lixo_p2 = limpa_palavras_pequenas(texto_limpo_p1, palavras_pequenas)
        ...
        TEXTO_LIMPO_P45 = texto_limpo_p45.lower()
        ...
        texto_final, texto_sobra = limpa_texto_final(texto_p9, texto_substantivos, texto_verbos, texto_nomes, texto_arcaismo)
        texto_lixo_final = f'{texto_lixo_p1} {texto_lixo_p2} {texto_lixo_p45} {texto_lixo_p3}'
